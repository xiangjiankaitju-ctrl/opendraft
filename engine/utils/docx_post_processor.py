...
def _clean_visible_residue(doc: Document, language: str) -> None:
    for para in doc.paragraphs:
        ...
        cleaned = re.sub(r"\{\{\s*cite_\d{3,}\s*\}\}|\{\s*cite_\d{3,}\s*\}|\bcite_\d{3,}\b", "", cleaned)
